...
string dirs[];
real d_fs[];
dirs.push("fits/low_t,high_t/e012+e023:f=0.0/st+sy"); d_fs.push(0.0);
dirs.push("fits/low_t,high_t/e012+e023:f=0.05/st+sy"); d_fs.push(0.05);
dirs.push("fits/low_t,high_t/e012+e023:f=0.1/st+sy"); d_fs.push(0.1);
dirs.push("fits/low_t,high_t/e012+e023:f=0.15/st+sy"); d_fs.push(0.15);
dirs.push("fits/low_t,high_t/e012+e023:f=0.2/st+sy"); d_fs.push(0.2);
dirs.push("fits/low_t,high_t/e012+e023:f=0.3/st+sy"); d_fs.push(0.3);
dirs.push("fits/low_t,high_t/e012+e023:f=0.4/st+sy"); d_fs.push(0.4);
dirs.push("fits/low_t,high_t/e012+e023:f=0.5/st+sy"); d_fs.push(0.5);
dirs.push("fits/low_t,high_t/e012+e023:f=0.6/st+sy"); d_fs.push(0.6);
dirs.push("fits/low_t,high_t/e012+e023:f=0.7/st+sy"); d_fs.push(0.7);
dirs.push("fits/low_t,high_t/e012+e023:f=0.8/st+sy"); d_fs.push(0.8);
dirs.push("fits/low_t,high_t/e012+e023:f=0.9/st+sy"); d_fs.push(0.9);
dirs.push("fits/low_t,high_t/e012+e023:f=1.0/st+sy"); d_fs.push(1.0);
